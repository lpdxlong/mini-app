...
use ooyyee\miniapp\exception\AppExecption;
...
abstract class MiniApp
{
     ...
     * @param array $extra
     * @throws NoAccessTokenException|AppExecption
    ...
    public function processAccessToken($url, $refreshToken, $extra = array())
    {
        ...
        if ($access_token && is_array($access_token)) {
            throw new AppExecption($access_token['errmsg'], isset($access_token['errcode']) ? $access_token['errcode'] : '0');
        }
